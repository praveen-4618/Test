...
public class Tbsched_Schedule_A1E9452EDD602A70DFEAE23864643438
		extends com.ibm.rational.test.lt.kernel.action.impl.Schedule {

	public Tbsched_Schedule_A1E9452EDD602A70DFEAE23864643438(IContainer parent, String name) {
		super(parent, name, "A1E9452EDD602A70DFEAE23864643438");
		setThinkMax(10000);
	...
	public class UserGroup_1 extends UserGroup {
		...
		public UserGroup_1(IContainer parent) {
			super(parent, "User Group 1", "A1E9452EDD609FACDFEAE23864643438");
		...
		private Container scenario_1(IContainer parent) {
			Container scenario = new Container(parent, "Default Scenario", "A1E9452EDD609FB7DFEAE23864643438") {
				...
				public void execute() {
					this.add(new test.Tbtest_Test_A1E9452E6BF91950DFEAE23864643438(this,
							"A1E9452EE191ED40DFEAE23864643438") {
						public void execute() {
